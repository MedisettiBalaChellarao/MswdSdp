...
const MyApplications = () => {
  ...
  useEffect(() => {
    try {
      if (user && user.role === "Employer") {
        axios
          .get("https://mswdsdpbackend.onrender.com/api/v1/application/employer/getall", {
        ...
        axios
          .get("https://mswdsdpbackend.onrender.com/api/v1/application/jobseeker/getall", {
            withCredentials: true,
          })
          .then((res) => {
            setApplications(res.data.applications);
  ...
  const deleteApplication = (id) => {
    try {
      axios
        .delete(`https://mswdsdpbackend.onrender.com/api/v1/application/delete/${id}`, {
          withCredentials: true,
        })
        .then((res) => {
  ...
  const handleStatusChange = async (id, newStatus) => {
    try {
      const response = await axios.post(
        `https://mswdsdpbackend.onrender.com/api/v1/job/application/update-status/${id}`,
        { status: newStatus },
        { withCredentials: true }
      );
